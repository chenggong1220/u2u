...
package com.u2u.framework.dal.mybatis.plugin;
...
import com.u2u.framework.dal.mybatis.dialect.Dialect;
import com.u2u.framework.util.PropertiesHelper;
import com.u2u.framework.util.ReflectionUtils;

/**
 * 
 * @ClassName: OffsetLimitInterceptor <br>
 * @Description: Mybatis 中拦截器的物理分页逻辑具体实现<br>
 * @date 2015-3-2 上午11:29:43 <br>
 * 
 * @author Freud
 */
...
public class OffsetLimitInterceptor implements Interceptor
{
    ...
    void processIntercept(final Object[] queryArgs)
    {
        ...
        if (dialect.supportsLimit() && (offset != RowBounds.NO_ROW_OFFSET || limit != RowBounds.NO_ROW_LIMIT))
        {
            ...
            Field metaParamsField = ReflectionUtils.getDeclaredField(newBoundSql, "metaParameters");
    ...
    public void setProperties(Properties properties)
    {
        ...
        // log.info(OffsetLimitInterceptor.class.getSimpleName()+".dialect="+dialectClass);
    }
