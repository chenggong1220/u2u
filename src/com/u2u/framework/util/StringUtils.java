 ...
 * @Description: String操作的工具类<br>
 * @date 2015-3-2 下午2:36:09 <br>
 * 
 * @author Dean
 */
public class StringUtils
{
     ...
     * <p>
     * A <code>null</code> source string will return <code>null</code>. An empty ("") source string will return the
     * empty string. A <code>null</code> remove string will return the source string. An empty ("") remove string will
