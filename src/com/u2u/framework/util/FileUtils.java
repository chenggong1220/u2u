...
public class FileUtils
{
    ...
    public static void uploadFile(MultipartFile multipartFile, File file)
        throws IllegalStateException, IOException
    {
        multipartFile.transferTo(file);
        LogUtil.info(log, "上传文件成功,保存在[" + file.getAbsolutePath() + "]");
    }
    
    public static void uploadFile(MultipartFile multipartFile, String file)
        throws IllegalStateException, IOException
    {
        uploadFile(multipartFile, new File(file));
    }
