...
public class VerifyLicense
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            licenseManager.install(new File(this.getClass().getResource("/").getPath()+licPath));
    ...
    private static LicenseParam initLicenseParams()
    {
        ...
        KeyStoreParam privateStoreParam =
            new DefaultKeyStoreParam(VerifyLicense.class, pubPath, PUBLICALIAS, STOREPWD, null);
