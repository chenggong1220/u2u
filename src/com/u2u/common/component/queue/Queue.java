 ...
 * 
 * @ClassName: Queue <br>
 * @Description: 策略型线程安全的队列(基于JDK1.5) <br>
 * @date 2015-3-2 上午11:21:41 <br>
 * 
 * @author Freud
 * @param <E>
 */
public class Queue<E> implements BaseQueue<E>, AdvanceQueue<E>, DiagnoseQueue<E>
{
    ...
    /**
     * 构造函数 为无界的，范围是int的最大值，所以offer,put时并不需要阻塞，一旦超出范围，将抛出OutOfMemoryError异常
     * 
    ...
    private class DefaultStrategy extends Strategy
    {
         ...
         * （非 Javadoc）
         * 
         * @see com.Ecointel.bsm.queue.PutWay#allowPut(com.Ecointel.bsm.queue.IQueue) 默认队列满时丢弃
         */
