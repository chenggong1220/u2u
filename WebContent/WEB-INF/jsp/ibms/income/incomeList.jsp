		...
		<div class="ibms_form_default">
			<ul>
				<li><font>客户：</font>
					...
					<li><font>开票状态：</font>
					<h1>
						<select id="invoiceStatus" name="invoiceStatus" class="easyui-combobox" data-options="editable:false">
							<option value="">全部</option>
...
<table id="querygrid" class="easyui-datagrid" title="财务列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'type',width:'10%',formatter:function(value,rec){if(rec.type==0){return '会员费';}else if(rec.type==1){return '保证金';}else{return '租金';}}">类型</th>
