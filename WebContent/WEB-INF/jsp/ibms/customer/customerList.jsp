	...
	<div class="easyui-panel ibms_form_panel"
		...
		<div class="ibms_form_default">
			<ul>
				...
				<li><font>客户类型：</font>
					<h1>
						<select id="custmerType" name="custmerType"
				...
				<li><font>客户等级：</font>
					<h1>
						<select id="custoerLevel" name="custoerLevel"
							class="easyui-combobox" data-options="editable:false">
							<option value="">全部</option>
...
<table id="querygrid" class="easyui-datagrid" title="客户列表"
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'custType',width:'5%',editor:'text',formatter:function(value,rec){if(value=='0'){return '个人' ;}else{return '企业';}}">客户类型</th>
