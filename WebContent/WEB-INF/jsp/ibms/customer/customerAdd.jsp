		...
		<div title="客户信息" class="dcim_form_panel" >
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
					<ul>
			           <li id="rentPerson"><font>客户类型：</font><h1>
				           <b><input type="radio"  name="rentPersonType" value="0" id="Radio1" checked="checked"/>个人</b>
		                   <b><input type="radio"  name="rentPersonType" value="1" id="Radio2"/>企业</b>
			           </h1></li>
			        </ul>
