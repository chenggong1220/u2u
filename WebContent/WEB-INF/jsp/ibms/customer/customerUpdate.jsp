			        ...
			        <div id="personDiv">
				        <ul>
							<li>
								<font>客户姓名：</font>
								<h1>
									<input name="name" value="${customer.rentPersonInfo.name}" type="text">
								</h1>
							</li>
							<li>
								<font>客户类型：</font>
								<h1><input name="rentPersonType" value="${customer.custType==0?'个人':'企业'}" type="text"></h1>
<!--  							
...
-->									
				           ...
				           <li><font>手机号：</font><h1><input id="mobile" name="mobile" value="${customer.rentPersonInfo.mobile}" type="text"></h1></li>
				           <li><font>电子邮箱：</font><h1><input id="email" name="email" value="${customer.rentPersonInfo.email}" type="text"></h1></li>
				        </ul>
			        	<div class="ibms_clear"></div>
				        <ul>
				           <li><font>省：</font><h1><input id="personProvince" name="personProvinceId" 
				           	value="${customer.rentPersonInfo.personProvinceId}" 
				            type="text" class="easyui-combobox"></h1></li>
				           <li><font>市：</font><h1><input id="personCity" name="personCityId" 
				           	value="${customer.rentPersonInfo.personCityId}" 
				            type="text" class="easyui-combobox"></h1></li>
							<li><font>邮政编码：</font><h1><input id="postcode" name="postcode" value="${customer.rentPersonInfo.postcode}"  type="text" ></h1></li>				           
					    </ul>
							<div class="ibms_clear"></div>
			        ...
			        <div id="companyDiv">
				        <ul>
				           <li><font>企业名称：</font><h1><input id="name" name="name" value="${customer.rentCompanyInfo.name}" type="text"></h1></li>
				           ...
				           <li><font>邮编：</font><h1><input name="postcode" postalAddress type="postcode" ></h1></li>
				        ...
				        <div class="ibms_form_default_textarea">
					        ...
					        <h1 style="width:90%;">
								<b>  <a class="POPUP_A" href="javascript:void(0);"><img width="300" height="200"
									...
									id="businessLicensePathPreview" name="businessLicensePathPreview" /></a>
								</b>									
							</h1>
						</div>
				        <div class="ibms_clear"></div>
				        ...
				        <div class="ibms_form_default_textarea">
					        ...
					        <h1 style="width:90%;">
								<b>  <a class="POPUP_A" href="javascript:void(0);"><img width="300" height="200"
									...
									id="lastYearApplicationFormPathPreview" name="lastYearApplicationFormPathPreview" /></a>
								</b>								
							</h1>
						</div>
				        <div class="ibms_clear"></div>
				        <ul>
				           <li><font>法人代表：</font><h1><input id="legalName" name="legalName"  value="${customer.rentCompanyInfo.legalName}" type="text" ></h1></li>
				           <li><font>联系电话：</font><h1><input id="legalMobile" name="legalMobile" value="${customer.rentCompanyInfo.legalMobile}" type="text" ></h1></li>
				           <li><font>Email：</font><h1><input name="legalEmail" value="${customer.rentCompanyInfo.legalEmail}" type="text" ></h1></li>
				        </ul>
		...
		<div title="紧急联系人信息" class="dcim_form_panel" >
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
			        <div class="ibms_clear"></div>
			        <ul>
			           <li><font>紧急联系人：</font><h1>
			           	<input id="emergencyContact" name="emergencyContact" value="${customer.emergencyContact}" 
			           	 type="text" class="easyui-validatebox" data-options="required:true"></h1></li>
			           <li><font>联系电话：</font><h1>
			           	<input id="emergencyMobile" name="emergencyMobile" value="${customer.emergencyMobile}" 
			           	 type="text" class="easyui-validatebox" data-options="required:true"></h1></li>
			           <li><font>关系：</font><h1>
			           	<input id="relation" name="relation"  value="${customer.relation}"
			           	 type="text" class="easyui-validatebox" data-options="required:true"></h1></li>
			        </ul>
		        	<div class="ibms_clear"></div>
		        </div>
	...
	<div class="ibms_form_btn">
        <a href="#" class="query_list_button auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/customer/save',autoclose:true">保存</a>
