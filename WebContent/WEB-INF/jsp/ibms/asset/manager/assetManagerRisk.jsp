...
<form id="addForm">
	<div id="infopointAccordion" class="easyui-accordion"
		...
		<div title="处置情况记录" class="dcim_form_panel">
			<div class="easyui-panel ibms_form_panel">
				<div class="project-record">
					<c:forEach var="risk" items="${risks}">
						<ul>
							<li>类型：<span>${risk.status==0?'处置':'催收' }</span></li>
							<li>日期：<span>${risk.viewDate }</span></li>
							<li>备注：<span>${risk.feedback}</span></li>
						</ul>
					</c:forEach>
				</div>
			</div>
		</div>
		<div title="处置情况描述" class="dcim_form_panel">
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
	...
	<div class="ibms_form_btn">
		<a href="#" class="query_list_button auto-savebutton"
			data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/asset/manager/risk/save',autoclose:true">保存</a>
