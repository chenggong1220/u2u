...
<form id="addForm">
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
	        ...
	        <ul>
	        	<li><font>合同编号：</font><h1><input id="city" name="cityId"  type="text" value="${contract.contractId }" disabled="disabled"></h1></li>
	           	<li><font>延期至：</font><h1><input id="selectDate" name="selectDate"  type="text" class="easyui-datebox"></h1></li>
	           <li><font>延期原因：</font><h1>
