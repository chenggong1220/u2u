			...
			<table id="rentAssetList" class="easyui-datagrid easyui-datagrid_2" title="租赁物列表"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'code',width:'20%',formatter:function(value,rec){return rec.asset.code;}">设备编号</th>
						<th data-options="field:'rentDateView',width:'20%'">起租时间</th>
					</tr>
				</thead>
			</table>
			<div id="rent_assets" style="height: auto">
				<a href="javascript:void(0)" class="easyui-linkbutton auto-addbutton_2"
...
<%-- 					data-options="iconCls:'icon-edit',d_width:'40%',d_height:'40%',plain:true,index:'id',url:'${pageContext.request.contextPath}/web/asset/manager/rent/edit'">翻单</a> --%>
				<a href="javascript:void(0)" class="easyui-linkbutton auto-delbutton_2"
