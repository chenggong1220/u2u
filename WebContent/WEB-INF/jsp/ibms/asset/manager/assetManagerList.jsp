	...
	<div class="easyui-panel ibms_form_panel"
		...
		<div class="ibms_form_default">
			<ul>
				...
				<li><font>签收状态：</font>
					<h1>
						<select id="checkinStatus" name="checkinStatus" class="easyui-combobox">
				...
				<li><font>签约状态：</font>
					<h1>
						<select id="signoffStatus" name="signoffStatus" class="easyui-combobox">
							<option value="">全部</option>
...
<table id="querygrid" class="easyui-datagrid" title="合同列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'contractId',width:'10%',formatter:function(value,rec){return '<a target=\'_blank\' href=\'${pageContext.request.contextPath}'+rec.saveLocation +'\'>' + value+'</a>' }">合同编号</th>
			<th data-options="field:'projectId',width:'10%',formatter:function(value,rec){return rec.project.projectId;}">项目编号</th>
			<th data-options="field:'rentType',align:'center',width:'8%',formatter:function(value,rec){if(rec.order.rentType==0){return '分时租赁';}else{return '分月租赁';}}">租赁类型</th>
			<th data-options="field:'orderName',width:'20%'">客户</th>
			<th data-options="field:'startDateTime',width:'8%',formatter:function(value,rec){return rec.order.startDatetime;}">起租时间</th>
			<th data-options="field:'rentDate',align:'center',width:'5%',formatter:function(value,rec){return rec.order.rentDate;}">租期</th>
