...
<form id="addForm">
	<div id="infopointAccordion" class="easyui-accordion"
		...
		<div title="原租赁物" class="dcim_form_panel" data-options="selected:true">
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
					...
					<input type="hidden" name="oldAssetId" value="${asset.asset.id }">
					<input type="hidden" name="managerRentAssetId" value="${asset.id }">
		        	<ul>
		           		<li><font>编号：</font><h1><input id="assetCode" name="assetCode" value="${asset.asset.code }" type="text"></h1></li>
		           		<li><font>状态：</font>
		           			<h1>
			           			<input id="rentStatus" name="rentStatus" type="text" class="easyui-combobox">
		           			</h1></li>
		...
		<div title="更换后租赁物" class="dcim_form_panel">
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
		        	<ul>
		           		<li><font>品牌：</font><h1><input id="brandId" name="brandId"  type="text"></h1></li>
			           <li><font>型号：</font><h1><input id="assetTypeId" name="assetTypeId"  type="text"></h1></li>
			           <li><font>设备ID：</font><h1><input id="newAssetId" name="newAssetId"  type="text"></h1></li>
		        	</ul>
	...
	<div class="ibms_form_btn">
       <a href="#" class="query_list_button auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/asset/manager/back/save',autoclose:true">保存</a>
