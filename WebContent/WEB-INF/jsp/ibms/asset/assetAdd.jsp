	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
	        <ul>
	           ...
	           <li><font>编码：</font><h1><input name="code"  type="text" ></h1></li>
	           <li><font>使用时长：</font><h1><input name="useTime"  type="text" ></h1></li>
	           <li><font>出租状态：</font><h1>
		           	<select name="rent" class="easyui-combobox" data-options="editable:false">
			           	<option value="1">空闲</option>
			           	<option value="0">已租</option>
						<option value="2">检修</option>
		           	</select>
	           </h1></li>
	           <li><font>所在位置：</font><h1><select name="location" class="easyui-combobox" data-options="editable:false">
	           	           	<option value="U2U">U2U</option>
							<option value="厂商">厂商</option>
	           </select></h1></li>
	           <li><font>加密狗：</font><h1><input name="softDog"  type="text" ></h1></li>
	           <li><font>是否保险：</font><h1><select name="insurance" class="easyui-combobox"  data-options="editable:false">
	           	           	<option value="false">否</option>
							<option value="true">是</option>
	           	</select></h1></li>
	           <li><font>保险单号：</font><h1><input name="insuranceId"  type="text" ></h1></li>
	           <li><font>保险金额：</font><h1><input name="insuranceAmount"  type="text" ></h1></li>
	        </ul>
        </div>
        <div class="ibms_clear"></div>
	    <div class="ibms_form_btn">
	        <a href="#" class="query_list_button auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/asset/save',autoclose:true">保存</a>
