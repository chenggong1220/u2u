...
<form id="addForm">
	<div class="easyui-panel ibms_form_panel">
		...
		<div class="ibms_form_default_textarea">
			<font>计费规则：</font>
			<h1>
				<textarea id="ck_editor" name="amountRule"></textarea>
			</h1>
		</div>
		<div class="ibms_clear"></div>
		<div class="ibms_form_default_textarea">
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/asset/combo/save',autoclose:true">保存</a>
