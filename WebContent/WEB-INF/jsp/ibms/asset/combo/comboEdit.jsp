	...
	<div class="easyui-panel ibms_form_panel">
		...
		<div class="ibms_form_default">
			<ul>
				<li><font>租赁类型：</font>
				<h1>
						<input id="rentTypeEdit" name="rentType" type="text"
							class="easyui-combobox">
					</h1></li>
				<li><font>明星类型：</font>
				<h1>
						<select id="starProduct" name="starProduct"
							class="easyui-combobox"></select>
					</h1></li>
				<li><font>品牌：</font>
				<h1>
						<input id="brand" name="brand" type="text" class="easyui-combobox">
					</h1></li>
				<li><font>型号：</font>
				<h1>
				...
				<li><font>名称：</font>
				<h1>
						<input name="name" type="text" value="${combo.name }">
					</h1></li>
				<li><font>费率：</font>
				<h1>
						<input name="amount" type="text" value="${combo.amount }">
					</h1></li>
				<li><font>最小时长：</font>
				<h1>
						<input name="minimumUseTime" type="text"
							value="${combo.minimumUseTime }">
					</h1></li>
			</ul>
		</div>
		...
		<div class="ibms_form_default_textarea">
			<font>计费规则：</font>
			<h1>
				<textarea name="amountRule">${combo.amountRule }</textarea>
			</h1>
		</div>
		<div class="ibms_clear"></div>
		<div class="ibms_form_default_textarea">
			<font>注意事项：</font>
			<h1>
				<textarea name="notice">${combo.notice }</textarea>
			</h1>
		</div>
		<div class="ibms_clear"></div>
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/asset/combo/update',autoclose:true">保存</a>
