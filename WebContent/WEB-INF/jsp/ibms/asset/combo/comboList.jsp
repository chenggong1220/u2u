...
<table id="querygrid" class="easyui-datagrid" title="套餐列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'rentType',width:'10%',formatter:function(value,rec){if(value=='0'){return '分时租赁' ;}else{return '分月租赁';}}">租赁类型</th>
			<th data-options="field:'brand',width:'20%',formatter:function(value,rec){return rec.assetType.brand;}">品牌</th>
			<th data-options="field:'model',width:'20%',formatter:function(value,rec){return rec.assetType.model;}">型号</th>
			<th data-options="field:'amount',width:'10%',editor:'text'">费率</th>
			<th data-options="field:'minimumUseTime',width:'20%'">最小使用时长</th>
			<th data-options="field:'starProduct',width:'10%',formatter:function(value,rec){if(value==true){return '是' ;}else{return '否';}}">是否明星类型</th>
		</tr>
	</thead>
</table>
