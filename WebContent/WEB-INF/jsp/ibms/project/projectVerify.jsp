...
-->						
	...
	<!-- Start: Add CompCode, by SUNZHE, 2017-01-16  -->						
							<li><font>企业代码：</font>
							<h1>
								<input id="compCode" name="compCode" value="${order.rentCompanyInfo.compCode}" type="text">
							</h1></li>		
						...
						<table cellspacing="0" cellpadding="0">
							...
							<tbody>
								<tr>
									...
									<td>身份证照片（正、反两面）</td>
									<td><select id="required1" name="required1"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required1Content" value="${project.required1Content }" /></td>
								</tr>
								<tr>
									<td class="text-center">2</td>
									<td>紧急联系人信息（姓名、联系方式、与承租人关系；联系人优先选择直系亲属）</td>
									<td><select id="required2" name="required2"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required2Content" value="${project.required2Content }" /></td>
								</tr>
								<tr>
									<td class="text-center">3</td>
									<td>租赁设备放置地证明</td>
									<td><select id="required3" name="required3"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required3Content" value="${project.required3Content }" /></td>
								</tr>
								<tr>
									<td class="text-center">4</td>
									<td>租赁设备放置地是否具备上网条件</td>
									<td><select id="required4" name="required4"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required4Content" value="${project.required4Content }" /></td>
								</tr>
								<tr>
									<td class="text-center">5</td>
									<td>提供承租人手持身份证照片（清晰可辨认）</td>
									<td><select id="required5" name="required5"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required5Content" value="${project.required5Content }" /></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table cellspacing="0" cellpadding="0">
							...
							<tbody>
								...
								<tr>
									...
									<td><select id="required6" name="required6"><option value="true">是</option><option value="false">否</option></select></td>
									<td><input type="text" name="required6Content" value="${project.required6Content }" /></td>
								</tr>
							</tbody>
						</table>
					</div>
...
<!-- End: Added pics for Comp, by SUNZHE, 2017-01-17	---->
					...
					<ul>
				        <li><font>三网截屏：</font>
			           		<h1>
								<b>
									<input type="file" name="identifyImageSelected" id="identifyImageSelected" accept="image/gif, image/jpeg, image/bmp, image/png"/>
									<input type="hidden" name="identifyImage" id="identifyImage" value="${project.identifyImage }"/>
								</b>
								<b>
									<input id="upload" type="button" class="query_list_button" value="上传" onclick="javascript:uploadFiles_framework('identifyImageSelected','identifyImage','identifyImagePreview');">
								</b>
							</h1>
						</li>
				    </ul>
				    ...
				    <div class="ibms_form_default_textarea">
					    <font>三网截屏：</font>
					    <h1 style="width:90%;">
							<b> <a class="POPUP_A" href="javascript:void(0);"><img width="300" height="200" src="${pageContext.request.contextPath}${project.identifyImage }" id="identifyImagePreview" name="identifyImagePreview"/></a></b>
						</h1>
					</div>
					<c:forEach var="projectPicture" items="${projectPictures }">
						<div id="sanwang_jietu_div_${projectPicture.pictureIndex }" class="sanwang_div_counter">
							<div class="ibms_clear"></div>
							<ul>
						      <li>
						      	<font>三网截屏：</font>
					        	<h1>
									<b>
										<input type="file" name="identifyImageSelected_${projectPicture.pictureIndex }" id="identifyImageSelected_${projectPicture.pictureIndex }" accept="image/gif, image/jpeg, image/bmp, image/png"/>
										<input type="hidden" name="identifyImage_${projectPicture.pictureIndex }" id="identifyImage_${projectPicture.pictureIndex }" value="${projectPicture.picture }"/>
									</b>
									<b>
										<input id="upload" type="button" class="query_list_button" value="上传" onclick="javascript:uploadFiles_framework('identifyImageSelected_${projectPicture.pictureIndex }','identifyImage_${projectPicture.pictureIndex }','identifyImagePreview_${projectPicture.pictureIndex }');">
									</b>
								</h1>
							  </li>
							  <li>
					          	<h1>
									<b>
										<a id="sanwang_jietu_aaa_${projectPicture.pictureIndex }" href="javascript:void(0)" class="sanwang_remove easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除</a>
									</b>
								</h1>
							  </li>
							</ul>
						    ...
						    <div class="ibms_form_default_textarea">
								<font>三网截屏：</font>
				  			  	<h1 style="width:90%;">
									<b> <a class="POPUP_A" href="javascript:void(0);"><img width="300" height="200" src="${pageContext.request.contextPath}${projectPicture.picture }" id="identifyImagePreview_${projectPicture.pictureIndex }" name="identifyImagePreview_${projectPicture.pictureIndex }"/></a></b>
								</h1>
							</div>
						</div>
					</c:forEach>
					...
					<ul>
				        <li><h1><b><a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="addSanwangJiePing()">添加三网截屏</a></b></h1></li>
