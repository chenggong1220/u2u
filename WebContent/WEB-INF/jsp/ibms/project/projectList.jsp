...
<table id="querygrid" class="easyui-datagrid" title="项目列表"
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'name',width:'25%',formatter:function(value,rec){return rec.order.customerName;}">客户姓名</th>
			<th
				data-options="field:'managerRealname',width:'10%',formatter:function(value,rec){return rec.order.manager.realname;}">客户专员</th>
			<!-- 			<th data-options="field:'operatorMobile',width:'15%',formatter:function(value,rec){return rec.order.manager.mobile;}">客户专员手机号</th> -->
			<th
				data-options="field:'result',width:'15%',formatter:function(value,rec){if(value==0){return '未保存' ;}else if(value==1){return '待复核';}else if(value==2){return '复核通过';}else if(value==4){return '信审拒绝';}else{return '项目审核拒绝';}}">状态</th>
