...
<table id="querygrid" class="easyui-datagrid" title="合同列表"
	data-options="
				...
				rownumbers:true,
				 fitColumns: true,
				singleSelect:true,
				url: '${pageContext.request.contextPath}/web/receive/list',
				pageSize:10,
				pageList: [1,2,5,10],
				collapsible:true,
				method: 'post'
	...
	<thead>
		<tr>
			...
			<th data-options="field:'deposit',width:'10%',formatter:function(value,rec){return rec.order.leftDeposit+'/'+rec.order.deposit}">保证金余额/总额</th>
			<th
...
<div id="tb" style="height: auto">
	<a href="javascript:void(0)" class="easyui-linkbutton auto-editbutton"
		data-options="iconCls:'icon-add',d_width:'50%',d_height:'50%',plain:true,index:'id',url:'${pageContext.request.contextPath}/web/receive/checkin'">收款</a>
</div>
