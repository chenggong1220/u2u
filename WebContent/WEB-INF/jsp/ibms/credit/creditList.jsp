	...
	<div class="easyui-panel ibms_form_panel"
		...
		<div class="ibms_form_default">
			<ul>
				...
				<li><font>信审状态：</font>
					<h1>
						<select id="creditResult" name="creditResult" class="easyui-combobox" data-options="editable:false">
...
<table id="querygrid" class="easyui-datagrid" title="信审项目列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'customerName',width:'25%',formatter:function(value,rec){return rec.order.customerName;}">客户姓名</th>
			<th data-options="field:'operator',width:'10%',formatter:function(value,rec){return rec.order.manager.realname;}">客户专员</th>
			<th data-options="field:'operatorMobile',width:'15%',formatter:function(value,rec){return rec.order.manager.mobile;}">客户专员手机</th>
			<th data-options="field:'creditResult',width:'10%',formatter:function(value,rec){if(value==0){return '未审核' ;}else if(value==1){return '待复核';}else if(value==2){return '复核通过';}else{return '信审拒绝';}}">状态</th>
