...
<form id="addForm" >
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
	        ...
	        <ul>
	           <li><font>版本号：</font><h1><input id="version" name="version" value="${appversion.version }" type="text"></h1></li>
      	...
      	<div class="ibms_form_btn">
	        <a href="#" class="query_list_button auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/appversion/update',autoclose:true">保存</a>
