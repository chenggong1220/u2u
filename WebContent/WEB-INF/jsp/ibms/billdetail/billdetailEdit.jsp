	...
	<div class="easyui-panel ibms_form_panel">
			...
			<ul>
				...
				<h1>
						<input id="dealDate" name="dealDate" type="text"
							value="${billdetail.dealDate }">
					</h1></li>
			</ul>
			<ul>
				<li><font>借方发生额：</font>
				<h1>
						<input name="amount" type="text" value="${billdetail.amount }">
					</h1></li>
			</ul>
			<ul>
				<li><font>已开票日期：</font>
				<h1>
						<input name="billdetailingDate" type="text"
							value="${billdetail.billdetailingDate }">
					</h1></li>
			</ul>
			<ul>
				<li><font>财务凭证号：</font>
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/billdetail/update',autoclose:true">保存</a>
