...
<table id="querygrid" class="easyui-datagrid" title="订单列表"
	data-options="
				...
				fitColumns: true,
				singleSelect:true,
				url: '${pageContext.request.contextPath}/web/suborder/list',
				pageSize:10,
				pageList: [1,2,5,10],
				collapsible:true,
				method: 'post'
	...
	<thead>
		<tr>
			...
			<th data-options="field:'mobile',width:'8%',formatter:function(value,rec){if(rec.rentPersonType=='0'){return rec.rentPersonInfo.mobile;}else{return rec.rentCompanyInfo.legalMobile}}">联系电话</th>
			...
			<th data-options="field:'operator',width:'10%',formatter:function(value,rec){return rec.manager.realname ;}">客户专员</th>
...
<div id="tb" style="height: auto">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton auto-editbutton"
			data-options="iconCls:'icon-edit',plain:true,d_width:'40%',d_height:'40%',index:'id',url:'${pageContext.request.contextPath}/web/suborder/seperate'">分单</a>
</div>
