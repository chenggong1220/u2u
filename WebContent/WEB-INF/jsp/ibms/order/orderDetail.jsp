					...
					<div id="personInfo"  hidden="hidden">
						...
						<ul>
							...
							<div class="ibms_form_default_textarea">
								<font>通讯地址：</font>
								<h1>
									<textarea id="postAddress" disabled="disabled" name="postAddress">${order.rentPersonInfo.address}</textarea>
								</h1>
							</div>	
							<div class="ibms_clear"></div>
							<div class="ibms_form_default_textarea">							
									<font>设备放置地：</font>
									<h1>
										<textarea id="machLocation" disabled="disabled" name="machLocation">${order.rentPersonInfo.personProvince}${order.rentPersonInfo.personCity}${order.detailLocation}</textarea>
									</h1>
							</div>								
