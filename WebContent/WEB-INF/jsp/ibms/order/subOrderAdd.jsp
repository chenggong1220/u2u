...
<form id="addForm">
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>订单ID：</font>
				<h1>
						<input id="detailLocation" name="detailLocation"
							disabled="disabled" type="text" value="${order.code }">
					</h1></li>
			</ul>
	...
	<div class="ibms_form_btn">
		<a href="#" class="query_list_button auto-savebutton"
			data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/suborder/save',autoclose:true">分单</a>
