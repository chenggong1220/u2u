				...
				<div class="ibms_form_default">
					<ul>
						<li>
							<font>订单号：</font>
							<h1>
								<input disabled="disabled" name="code" value="${order.code}" type="text">
							</h1>
						</li>
						<li>
							<font>创建时间：</font>
							<h1>
								<input disabled="disabled" name="createDate" value="${order.viewDate}" type="text">
							</h1>
						</li>
<!--
						<li>
...
-->
						<li>
							<font>客户类型：</font>
							<h1>
								<input disabled="disabled" name="rentType" value="${order.rentPersonType==0?'个人':'企业'}"  type="text">
							</h1>
						</li>
						<li>
							<font>来源：</font>
							<h1>
								<input disabled="disabled" name="createSource" value="${order.createSource==0?'APP':'WEB后台' }" type="text">
							</h1>
						</li>
					</ul>
					...
					<div id="personInfo"  hidden="hidden">
						<ul>
							<li>
								<font>联系人：</font>
								<h1>
									<input disabled="disabled" name="name" value="${order.rentPersonInfo.name}" type="text">
								</h1>
							</li>
							<li>
								<font>手机号码：</font>
								<h1>
									<input disabled="disabled" name="mobile" value="${order.rentPersonInfo.mobile}" type="text">
								</h1>
							</li>
							<li>
								<font>Email：</font>
						...
						<div class="ibms_form_default_textarea">
							<font>设备放置地：</font>
							<h1>
								<textarea id="machLocation" name="machLocation" disabled="disabled">${order.rentPersonInfo.personProvince}${order.rentPersonInfo.personCity}${order.detailLocation}</textarea>
							</h1>							
						</div>												
...
<!-- Start: Add by SUNZHE, 2017-01-15 -->
						<ul>
							<li>
								<font>紧急联系人：</font>
								<h1>
									<input disabled="disabled" name="mobile" value="${order.rentPersonInfo.emergencyContact}" type="text">
								</h1>
							</li>
							...
							<li>
								<font>关系：</font>
								<h1>
									<input disabled="disabled" name="mobile" value="${order.rentPersonInfo.relation}" type="text">
								</h1>
							</li>
							...
							<li>
								<font>联系电话：</font>
								<h1>
									<input disabled="disabled" name="mobile" value="${order.rentPersonInfo.emergencyContactMobile}" type="text">
								</h1>
							</li>
						</ul>
					...
					<div id="companyInfo" hidden="hidden">
						<ul>
							<li>
								<font>企业名称：</font>
								<h1>
									<input disabled="disabled" name="compName" value="${order.rentCompanyInfo.name}" type="text">
								</h1>
							</li>						
						</ul>					
						<ul>
							<li>
								<font>联系人：</font>
								<h1>
									<input disabled="disabled" name="legalName" value="${order.rentCompanyInfo.legalName}" type="text">
								</h1>
							</li>
							<li>
								<font>手机号码：</font>
								<h1>
									<input disabled="disabled" name="legalMobile" value="${order.rentCompanyInfo.legalMobile}" type="text">
								</h1>
							</li>
							<li>
								<font>Email：</font>
						...
						<div class="ibms_form_default_textarea">
							<font>通讯地址：</font>
							<h1>
								<textarea id="postalAddress" name="postalAddress" disabled="disabled">${order.rentCompanyInfo.postalAddress}</textarea>
							</h1>
						</div>						
						<div class="ibms_clear"></div>
						<div class="ibms_form_default_textarea">
			...
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
					<ul>
						...
						<li>
							<font><a id="identifyCertificationButton" href="#" class="easyui-linkbutton">验 证</a></font>
							<h1></h1>
						</li>
					</ul>
					<div class="ibms_clear"></div>
					<div class="ibms_form_default_textarea">	
						...
						<h1 style="width: 90%;">
							<b> <img width="300" height="200"
								src="${pageContext.request.contextPath}" name="identifyCertification" id="identifyCertification"/>
							</b>
						</h1>
					</div>
