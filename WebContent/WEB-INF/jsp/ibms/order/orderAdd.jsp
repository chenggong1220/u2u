			...
			<div class="easyui-panel ibms_form_panel">
				<div class="ibms_form_default">
					...
					<ul>
						...
						<li><font>具体位置：</font>
						<h1>
								<input id="detailLocation" name="detailLocation" type="text"
					...
					<ul>
						<li><font>开始时间：</font>
							<h1>
								<input id="startDate" name="startDatetime" type="text"
					...
					<ul>
						<li><font>是否开票：</font>
							<h1>
								<select id="needInvoices" name="needInvoices"
									class="easyui-combobox" data-options="required:true">
...
// 				});
					...
					<ul>
						...
						<h1>
								<b><input type="radio" name="rentPersonType" value="0"
									id="Radio1" checked="checked" />个人租赁</b> <b><input type="radio"
									name="rentPersonType" value="1" id="Radio2" />企业租赁</b>
							</h1></li>
					</ul>
					<script type="text/javascript">
	...
	<div class="ibms_form_btn">
		<a href="#" class="query_list_button auto-savebutton"
			data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/order/save',autoclose:true">保存</a>
