...
<form id="addForm" >
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
	        ...
	        <div class="ibms_clear"></div>
	        <ul>
	           <li><font>发送对象：</font><h1><input id="userId" name="userId"  type="text"></h1></li>
	        </ul>
	        <div class="ibms_clear"></div>
	    ...
	    <div class="ibms_form_btn">
	        <a href="#" class="query_list_button auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/sysmessage/save',autoclose:true">保存</a>
