...
<form id="queryForm">
	<div class="easyui-panel ibms_form_panel"
		data-options="iconCls:'icon-search',collapsible:true" title="系统人员消息查询">
...
<table id="querygrid" class="easyui-datagrid" title="系统人员消息列表"
	data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				toolbar: '#tb',
				...
				rownumbers:true,
				 fitColumns: true,
				singleSelect:true,
				url: '${pageContext.request.contextPath}/web/sysmessage/list',
				pageSize:10,
				pageList: [10,20,50],
				collapsible:true,
				method: 'post'
...
<div id="tb" style="height: auto">
	<a href="javascript:void(0)" class="easyui-linkbutton auto-editbutton"
		data-options="iconCls:'icon-save',plain:true,index:'id',title:'查看详情',url:'${pageContext.request.contextPath}/web/sysmessage/view'">查看</a>
	<a href="javascript:void(0)" class="easyui-linkbutton auto-addbutton"
		data-options="iconCls:'icon-add',plain:true,url:'${pageContext.request.contextPath}/web/sysmessage/add'">添加</a>
	<a href="javascript:void(0)" class="easyui-linkbutton auto-delbutton"
		data-options="iconCls:'icon-remove',plain:true,index:'id',url:'${pageContext.request.contextPath}/web/sysmessage/delete'">删除</a>
</div>
