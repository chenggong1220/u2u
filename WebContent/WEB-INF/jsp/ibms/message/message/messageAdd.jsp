	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>对象类型：</font>
				<h1>
						<select id="msgType" name="msgType" class="easyui-combobox"
							data-options="editable:false">
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/message/save',autoclose:true">保存</a>
