	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>已开票日期：</font>
				<h1>
						<input name="billingDate" type="text" value="${bill.billingDate }">
					</h1></li>
			</ul>
			<ul>
				<li><font>财务凭证号：</font>
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/bill/update',autoclose:true">保存</a>
