	...
	<div class="easyui-panel ibms_form_panel"
		...
		<div class="ibms_form_default">
			<ul>
				...
				<li><font>签收状态：</font>
					<h1>
						<select id="checkinStatus" name="checkinStatus" class="easyui-combobox" data-options="editable:false">
				...
				<li><font>签约状态：</font>
					<h1>
						<select id="signoffStatus" name="signoffStatus" class="easyui-combobox" data-options="editable:false">
							<option value="">全部</option>
					...
					<li><font>合同类型：</font>
					<h1>
						<select id="contractType" name="contractType" class="easyui-combobox" data-options="editable:false">
							<option value="">全部</option>
...
<table id="querygrid" class="easyui-datagrid" title="合同列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'contractId',width:'10%',formatter:function(value,rec){return '<a target=\'_blank\' href=\'${pageContext.request.contextPath}'+rec.saveLocation +'\'>' + value+'</a>' }">合同号</th>
			...
			<th data-options="field:'sendStatus',width:'8%',formatter:function(value,rec){if(value==false){return '未发货' ;}else{return '已发货';}}">发货状态</th>
			<th data-options="field:'backStatus',width:'8%',formatter:function(value,rec){if(value==false){return '未归还' ;}else{return '已归还';}}">归还状态</th>
