	...
	<div class="easyui-panel ibms_form_panel">
			...
			<ul>
				...
				<h1>
						<input name="selectDate" type="text"
							value="${contract.signoffDate }" class="easyui-datebox"
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/contract/signoff/save',autoclose:true">保存</a>
