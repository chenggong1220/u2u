...
<table id="querygrid" class="easyui-datagrid" title="合同列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'sendStatus',width:'10%',formatter:function(value,rec){if(value==false){return '未发货' ;}else{return '已发货';}}">发货状态</th>
			<th data-options="field:'sendCheckinStatus',width:'10%',formatter:function(value,rec){if(value==false){return '未到货' ;}else{return '已到货';}}">到货状态</th>
			<th data-options="field:'backStatus',width:'10%',formatter:function(value,rec){if(value==false){return '未归还' ;}else{return '已归还';}}">归还状态</th>
