	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>设备编号：</font>
				<h1>
						<input name="code" type="text" value="${asset.asset.code }"
							disabled="disabled">
					</h1></li>
				<li><font>收货时间：</font>
				<h1>
						<input name="selectDate" type="text"
							value="${asset.receiveDateView }" class="easyui-datebox"
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/send/manager/send/checkin/save',autoclose:true">保存</a>
