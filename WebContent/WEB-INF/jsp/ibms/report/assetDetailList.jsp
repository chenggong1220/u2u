...
<table id="querygrid" class="easyui-datagrid" title="租赁物列表"
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'model',width:'8%',editor:'text',formatter:function(value,rec){return rec.assetType.model;}">设备型号</th>
			<th
				data-options="field:'rent',width:'6%',editor:'text',formatter:function(value,rec){if(value==0){return '已租'}else if(value==1){return '空闲'}else{return '检修'}}">状态</th>
			<th data-options="field:'contractId',width:'10%',editor:'text'">合同编号</th>
			<th
				data-options="field:'rentPersonType',width:'5%',editor:'text',formatter:function(value,rec){if(value=='0'){return '个人' ;}else{return '企业';}}">客户类型</th>
