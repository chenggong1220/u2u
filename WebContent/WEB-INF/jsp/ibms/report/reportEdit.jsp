	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>名称：</font>
				<h1>
						<input id="name" name="name" type="text" value="${shop.name }">
					</h1></li>
			</ul>
			<ul>
				<li><font>地址：</font>
			...
			<ul>
				<li><font>BU：</font>
				<h1>
						<input id="bid" name="bid" type="text" class="easyui-combobox"
							data-options="required:true" value="${shop.bid}">
					</h1></li>
			</ul>
			<ul>
				<li><font>联系人：</font>
			...
			<ul>
				<li><font>备注：</font>
				<h1>
						<input name="note" type="text" value="${shop.note }">
					</h1></li>
			</ul>
		</div>
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/shop/update',autoclose:true">保存</a>
