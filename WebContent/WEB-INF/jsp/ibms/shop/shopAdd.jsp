	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			...
			<ul>
				<li><font>BU：</font>
				<h1>
						<input id="bid_add" name="bid" type="text" class="easyui-combobox"
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/web/shop/save',autoclose:true">保存</a>
