...
<div class="easyui-panel ibms_form_panel"
	data-options="iconCls:'icon-search'" title="系统日志查询">
	<form action="">
		<div class="ibms_form_default">
			<ul class="ibms_clear">
				<li><font>操作人：</font>
				<h1>
						<input name="username" id="username" class="textbox test" />
					</h1></li>
				<li><font>起始时间：</font>
				<h1>
						<input name="startDate" id="startDate"
							class="easyui-datebox textbox" />
					</h1></li>
				<li><font>结束时间：</font>
				<h1>
						<input name="endDate" id="endDate" class="easyui-datebox textbox" />
					</h1></li>
			</ul>
		</div>
