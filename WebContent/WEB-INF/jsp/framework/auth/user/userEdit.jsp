	...
	<div class="easyui-panel ibms_form_panel">
		<div class="ibms_form_default">
			<input name="id" type="hidden" value="${user.id}"> <input
				name="username" type="hidden" value="${user.username}">
			<ul>
				<li><font>用户名：</font>
				<h1>
				...
				<h1>
						<input id="password" name="password" type="password"
							value="${user.password}" class="easyui-validatebox"
			...
			<ul>
				...
				<h1>
						<input id="mobile" name="mobile" type="text"
							value="${user.mobile }" class="easyui-validatebox"
				...
				<li><font>邮箱：</font><h1><input id="email" name="email" type="text" value="${user.email }"></h1></li>					
			</ul>
			<div class="ibms_clear"></div>
			<ul>
				<li><font>BU：</font>
		...
		<div class="ibms_form_btn">
			<a href="#" class="query_list_button auto-savebutton"
				data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/auth/user/update',autoclose:true">修改</a>
...
$('#cities').combotree({
    ...
    onLoadSuccess: function(node,data){
    	$('#cities').combotree('setValues', ${cities});
