...
<form id="addForm">
	<div id="role" class="easyui-layout" fit="true">
		<div data-options="region:'north'"
			...
			<div class="easyui-toolbar">
				<a href="#" class="easyui-linkbutton auto-savebutton"
					data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/auth/role/save',autoclose:true">添加</a>
		...
		<div data-options="region:'west'" style="width: 200px; padding: 5px;">
			<span style="display: block; padding-bottom: 5px;">角色名：</span> <input
				id="rolername" name="rolename" type="text"
