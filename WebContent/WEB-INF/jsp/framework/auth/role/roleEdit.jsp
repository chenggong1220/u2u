	...
	<div id="role" class="easyui-layout" fit="true">
	    <div data-options="region:'north'" style="height:30px;overflow:hidden;">
	   	    <div class="easyui-toolbar">
		       	<a href="#" class="easyui-linkbutton auto-savebutton" data-options="iconCls:'icon-save',plain:true,url:'${pageContext.request.contextPath}/auth/role/update',autoclose:true">保存</a>
...
<!-- 	        <input id="rolername" name="rolename" type="text" class="easyui-validatebox" data-options="required:true,validType:'minLength[1]'"> -->
	        ...
	        <h1><label>${role.rolename}</label></h1>
	    </div>
	    <div data-options="region:'center'" style="padding:5px;" id="resourceValues" tvalue="${role.resources}">
