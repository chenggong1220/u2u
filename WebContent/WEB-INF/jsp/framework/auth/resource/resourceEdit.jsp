...
<form id="editMenuResources">
	...
	<input type="hidden" name="parentsResource" value="${resource.parentsResource}">
	<div class="ibms_form_default"
		style="padding-top: 5px; border-bottom: 1px dotted #ccc; background: #f4f4f4;">
		<ul>
			<li><font>资源名称：</font>
				<h1>
					<input id="resourceName" name="resourceName" type="text" value="${resource.resourceName }" class="easyui-validatebox" data-options="required:true,validType:'minLength[1]'">
				</h1></li>
			<li><font>资源优先级：</font>
				<h1>
					<input id="priority" name="priority" type="text" value="${resource.priority }" class="easyui-validatebox" data-options="required:true,validType:'number'">
				</h1></li>
			<li><font>URL：</font>
				<h1>
			...
			<li><font>资源图片：</font>
				<h1>
					<input id="imageUrl" name="imageUrl" type="text" value="${resource.imageUrl}">
				</h1></li>
			<li><font></font>
				<h1>
					<b><input id="validate" name="validate" type="checkbox" tvalue="${resource.validate}">是否可用</b>
				</h1></li>
			</ul>
